...
// ye function latest chat aur image dikhane ke kam ayega when you open it showe uper se niche (latest image)
  useEffect(()=>{
   ...
   <div className='flex-1 flex flex-col justify-between m-5 md:m-10 xl:mx-30 max-md:mt-14 2xl:pr-40'>
    ...
    {mode === 'image' && (
      <label className='inline-flex items-center gap-2 mb-3 text-sm mx-auto'>
        <p className='text-xs'>Publish generated image to comunity </p>
